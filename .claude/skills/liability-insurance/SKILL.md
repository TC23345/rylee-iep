...
7. **NSSEO conflict-of-interest gate**. If at any point the conversation reveals that NSSEO's employment terms might restrict private practice (non-compete, conflict-of-interest policy, requirement to disclose outside employment), invoke `.claude/shared/disclaimer.md` and route the question to NSSEO HR + her employment attorney. This skill does not interpret employment contracts.
