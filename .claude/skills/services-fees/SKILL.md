...
5. **Contract terms gate.** If Rylee asks "what's my late fee policy" or "how do I handle cancellations contractually" — invoke `.claude/shared/disclaimer.md`, state this is attorney territory, and add the question to the `intake-process` services-agreement checklist instead.
