...
- A final trademark clearance — that's a USPTO TESS search plus an IP attorney's review
...
7. **Do not** invoke the disclaimer for naming work. This is brainstorming territory. The disclaimer applies only when Rylee crosses into entity-form selection or contract terms (those are different skills).

## What Rylee already knows

- She is a BCBA; her credential matters for how the name reads to school staff
- "Advocacy" vs "consulting" vs "support" carries weight in special ed circles — present these as deliberate choices, don't explain them
