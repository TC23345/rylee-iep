...
Cross-module skill for the **Initial Research Context** placeholder on each dashboard H2 (below the divider on module pages). Invoked via **`/initial-research <N>`** — see `.claude/commands/initial-research.md` for the full procedure.
...
- Legal, tax, or IDFPR assertions — gate per `.claude/shared/disclaimer.md`

## Before running

Read:

1. `.claude/commands/initial-research.md` — canonical procedure
2. `.claude/shared/rylee-profile.md` — query framing
