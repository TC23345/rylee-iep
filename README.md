# IEP Advocacy Journey: Rylee Coteus
...
- Confirm directory structure works in Claude Code (`/help` shows the commands, skills auto-discover)
- Don't deep-edit the Module 1 skills yet — the debrief workflow will handle that

### During each module (weekly cadence)

0. **Optional pre-module research** → run [`/initial-research <N>`](.claude/commands/initial-research.md) to draft Initial Research Context from `modules.md` + Perplexity (review before pasting into dashboard)
...
│   ├── commands/                   ← /new-client, /initial-research, /module-debrief, /checklist, /weekly-review
│   └── skills/                     ← module skills + initial-research (pre-module workflow)
