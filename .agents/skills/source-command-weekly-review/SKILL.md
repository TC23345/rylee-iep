...
1. **Pin the cohort week**. Cohort start: 2026-06-01 (from `.Codex/shared/course-context.md`).
...
2. **Scan recent activity**:
   - `.Codex/CHANGELOG.md` — entries since the last `## YYYY-MM-DD` matching last week or later
