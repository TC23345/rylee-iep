---
name: "source-command-new-client"
...
# source-command-new-client

Use this skill when the user asks to run the migrated source command `new-client`.
...
2. **Construct `client_id`** per `.Codex/shared/pii-policy.md`: lowercase, hyphen-separated, format `<first>-<last-initial>-<district-abbr>` (e.g., `marcus-t-d214`).
...
5. **Create the folder** and copy each template from `.Codex/skills/intake-process/assets/` into it:
   - `intake-form.md`
   - `welcome-packet.md`
   - `iep-checklist.md`
   - `session-log.md`
...
- Do not write the full last name anywhere — last initial only, per `.Codex/shared/pii-policy.md`
